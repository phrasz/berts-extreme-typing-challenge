...
//                  Front Creation
    ...
    f = al_load_ttf_font("data/3.ttf", 138, 0); //name, //int size, int flags ALLEGRO_TTF_NO_KERNING &_MONOCHROME
    if (!f) {
        //abort_example("Failed to load keys.ttf\n");
        return 1;
    }
    f2 = al_load_ttf_font("data/1.ttf", 47, 0); //name, //int size, int flags ALLEGRO_TTF_NO_KERNING &_MONOCHROME
    if (!f2) {
        //abort_example("Failed to load keys.ttf\n");
        return 1;
    }
                   ...
                   // }
                    ...
                    if(round==1){
                        if(credcount==1){
                            ...
                            fadespeed=-120; //transistion audio delay...
                            credcount=0;
                            ...
                            round=6;
                            fadespeed=-200; //transistion audio delay...
                            credcount=0;
                            //al_stop_sample_instance(sample_inst);
